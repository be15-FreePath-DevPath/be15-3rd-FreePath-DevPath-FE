<template>
  <div class="sidebar-section">
    ...
    <div class="section-header" @click="toggleOpen">
      ...
      <img :src="newsIcon" alt="IT 아이콘" class="section-icon" />
      <span class="section-title">IT 기사</span>
    </div>

    <!-- 하위 메뉴 리스트 컨테이너 -->
    <div v-if="isOpen" class="menu-list">
      <SidebarItem text="IT 기사 목록" to="/admin/news/list" />
...
import newsIcon from '@/assets/images/common/sidebar/sidebar-it-icon.png'
