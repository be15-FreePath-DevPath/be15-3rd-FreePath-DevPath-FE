<template>
  <div class="sidebar-section">
    ...
    <div class="section-header" @click="toggleOpen">
      ...
      <img :src="interviewIcon" alt="모의 면접 아이콘" class="section-icon" />
      <span class="section-title">모의 면접</span>
    </div>

    <!-- 하위 메뉴 리스트 컨테이너 -->
    <div v-if="isOpen" class="menu-list">
      <SidebarItem text="모의 면접 목록" to="/interview/list" />
      <SidebarItem text="모의 면접 실행" to="/interview/run" />
    </div>
  </div>
</template>
...
import interviewIcon from '@/assets/images/common/sidebar/sidebar-interview-icon.png'
