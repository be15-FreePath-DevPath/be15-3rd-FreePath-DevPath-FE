<template>
  <div class="sidebar-section">
    ...
    <div class="section-header" @click="toggleOpen">
      ...
      <img :src="csquizIcon" alt="CS 퀴즈 아이콘" class="section-icon" />
      <span class="section-title">CS 퀴즈</span>
    </div>

    <!-- 하위 메뉴 리스트 컨테이너 -->
    <div v-if="isOpen" class="menu-list">
      <SidebarItem text="CS 퀴즈 목록" to="/admin?tab=quiz" />
...
import csquizIcon from '@/assets/images/common/sidebar/sidebar-csquiz-icon.png'
